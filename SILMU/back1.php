    ...
    <script type="text/javascript" src="drag22.js"></script>
     ...
     <div class="row" style="margin:0px; height:100%;">
        ...
        foreach($rivit as $i) {
            echo
            "<tr><td>
            <input type='image' src='$i[1]' alt='kuvak' style=' height:150px; width:100%;'  name='kuvak' value='v$cy'>";
        $cy = $cy + 1;
            }
        foreach($rivii as $i) {
            echo "<tr><td>
            <input type='image' src='$i[1]' alt='kuvak' style=' height:150px; width:100%;'  name='kuvak' value='o$ck'>";
        $ck = $ck + 1;
        }
                        ...
                        <div class="modal-content" style="padding: 5px">
                          ...
                          <div class="modal-body">
                           ...
                           ?>
                            ...
                            <form enctype="multipart/form-data" role="form" action="back1.php" method="post">
