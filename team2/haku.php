          ...
          <div class="taulu">
              <table>
                  <form action="haku.php" method="get">
                      ...
                      <tr><td><input type="text" name="sotu"style="width:360px;"placeholder="asukkaan sotu"></input></td></tr>
                      <tr><td><label>Tai</label><td></tr>
                      <tr><td><input type="text" name="id	"style="width:360px;" placeholder="kuitin numero"></input></td></tr>
                      <tr><td><button style="margin-top:5px;">Hae >></button></td></tr>
                  </form>
              </table>
              <a style="margin-top:20px;"class="btn btn-lg btn-primary" href="asiakkaat.php" role="button">Hallitse asiakkaita »</a>
              <a style="margin-top:20px; margin-left:10px;"class="btn btn-lg btn-primary" href="asunnot.php" role="button">Hallitse asuntoja »</a>
          </div>
